...
mysqli_query($conn,"insert into payments(trans_id,chama,item_name,payment_gross,payment_status,mobile,name) values ('$MERCHANT_TRANSACTION_ID','$chama','$item_name', '$ammount','Complete','$number','$paidby')") or die(mysqli_error($conn));
