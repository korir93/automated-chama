                    ...
                    <div class="portlet light">
                        <div class='row'>
                            <strong>Live search:</strong>
                                <input type="text" id="myInput" name="search" placeholder="Transaction ID" onkeyup="myFunction()" style="border: 1px solid #cccccc; border-radius: 4px;-webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075);-webkit-transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s;transition: border-color ease-in-out .15s, box-shadow ease-in-out .15s; padding: 3px 8px; vertical-align: middle; background-color: #ffffff;"><br><br>
                            <div class="col-md-12">
                                <div class="panel panel-primary" id="myDivId">
                        <div class="panel-heading">
                            <center>
                                <font size="4" style="font-family: sans-serif;">Group withdrawals</font>
                            </center>
                        </div>
