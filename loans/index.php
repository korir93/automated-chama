...
mysqli_query($conn,'insert into mychama_loans (name, fine, amount, chama) values ("'.$name.'","'.$fine.'","'.$amount.'","'.$session.'")') or die(mysqli_error($conn));
echo "<script>window.alert('Loan created successfully!');</script>";}
}
mysqli_close($conn);
?>
<!DOCTYPE html>
        ...
        <div class="page-actions">
            <div id='quick-actions' class="btn-group hidden-xs">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <a href="../loans/">
                            <i class="fa fa-plus"></i> Create Loan </a>
                    </li>
                    <li>
                        <a href="merry.php">
                        ...
                        <div class="portlet light bordered" id="form_wizard_1">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red bold uppercase"> Create group loan</span>
                                </div>
                            </div>
...
<div id="group_member_options">
    <div class="row">
        <div id="heading" class="col-sm-12">
            <h3 class="text-center">Do you wish to add your loans?</h3>
        </div>
    </div>
</div>
...
<div class="row margin-top-20">
    <div class="col-sm-12 text-center">
        <a href="#" class="inline btn btn-lg blue" data-toggle="modal" data-target="#add_new_member">
            <i class="fa fa-money"></i> Add Loan Now  
        </a>
    </div>
</div>
    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            ...
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo $name."'s loans"; ?></h3>
            </div>
            <!-- Table -->
                ...
                <tbody>
                    <tr>
                        <?php
                            $conn = mysqli_connect('localhost', 'root', '', 'mychama');
                            /*$conn = mysqli_connect('localhost', 'findpata_snippetc', 'Manusoftwares2946', 'findpata_sokoni') or die(mysqli_error($conn));*/
                            $results = mysqli_query($conn,"select * from mychama_loans where chama = '".$session."'") or die(mysqli_error($conn));
                            while($rows = mysqli_fetch_assoc($results)){
                        ?>
                        <td class="member-name"><?php echo $rows['name']; ?></td>
                        <td class="member-contacts"><?php echo $rows['amount']; ?></td>
                        <td class="group-role-name"><?php echo $rows['fine']; ?></td>
                        <td>
                        ...
                        <table class="table table-bordered" id="tbl_posts">
                            ...
                            <tbody id="tbl_posts_body">
                                <tr id="rec-1">
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="txtName[]" placeholder="Loan's name" required>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="txtMobile[]" placeholder="Default penalty" required>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="txtMail[]" placeholder="1,000" required>
                                    </td>
                        ...
                        <table class="table table-bordered" id="tbl_posts">
                            ...
                            <tbody id="tbl_posts_body">
                                <tr id="rec-1">
                                    ...
                                    <?php
                                        $conn = mysqli_connect('localhost', 'root', '', 'mychama');
                                        $resultss = mysqli_query($conn,"select * from mychama_loans where chama = '".$session."'") or die(mysqli_error($conn));
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="txtMobile[]" placeholder="+254xxxxxxxxx" required value="<?php echo $rowss['amount']; ?>">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="txtMail[]" placeholder="Email address" required value="<?php echo $rowss['fine']; ?>">
                                    </td>
                                    <td><a class="btn btn-xs delete-record" data-id="1"><i class="glyphicon glyphicon-trash"></i></a></td>
                                </tr>
                            </tbody>
...
<div style="display:none;">
    <table id="sample_table">
        <tr id="">
            ...
            <td>
                <input type="text" class="form-control" name="txtMobile[]" placeholder="Default penalty" required>
            </td>
            <td>
                <input type="number" class="form-control" name="txtMail[]" placeholder="1,000" required>
            </td>
