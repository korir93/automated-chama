...
if (isset($_POST['btnMembers'])) {
    for ($i=0; $i < count($_POST['txtName']); $i++) {
        $iname = $_POST['txtName'][$i];
        $imobile = $_POST['txtMobile'][$i];
        $imail = $_POST['txtMail'][$i];
        $irole = $_POST['txtRole'][$i];
        mysqli_query($conn,"insert into mychama_members(name,mobile,email,role,chama,username,password) values ('$iname','$imobile','$imail', '$irole','$session','$imail','$imobile')") or die(mysqli_error($conn));
        $message = "Dear $iname, $name added you to MyChama. Login at https://mychama.findpata.com and use $imail as username and your mobile number as passcode";
        require_once('../AfricasTalkingGateway.php');
        $gateway    = new AfricasTalkingGateway("findpata", "427e7b2ea5cc866df675db45c87d18ce0a36e75aeb1b5bf6e0c4af6394b1b1fc");
        try 
        {
          $results = $gateway->sendMessage($imobile, $message);           
    ...
    echo "<script>window.alert('Member(s) added successfully!');</script>";
}
...
if (isset($_POST['btnEditMembers'])) {
    for ($i=0; $i < count($_POST['txtName']); $i++) {
        ...
        mysqli_query($conn,"update mychama_members set name='".$ename."',email='".$email."',role='".$erole."' where email='".$email = $_POST['txtMail'][$i]."'") or die(mysqli_error($conn));
    }
...
<div id="group_member_options">
	<div class="row">
		<div id="heading" class="col-sm-12">
			<h3 class="text-center">Do you wish to add your group members now?</h3>
		</div>
	</div>
</div>
...
<div class="row margin-top-20">
    <div class="col-sm-12 text-center">
    	<a href="#" class="inline btn btn-lg blue" data-toggle="modal" data-target="#add_new_member">
            <i class="fa fa-user-plus"></i> Add Group Members Now  
        </a>
    </div>
</div>
	...
	<div class="col-sm-12">
		<div class="panel panel-info">
            ...
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo $name."'s members"; ?></h3>
            </div>
            <!-- Table -->
                ...
                <tbody>
            	    <tr>
                        <?php
                            $conn = mysqli_connect('localhost', 'root', '', 'mychama');
                            /*$conn = mysqli_connect('localhost', 'findpata_snippetc', 'Manusoftwares2946', 'findpata_sokoni') or die(mysqli_error($conn));*/
                            $results = mysqli_query($conn,"select * from mychama_members where chama = '".$session."'") or die(mysqli_error($conn));
                            while($rows = mysqli_fetch_assoc($results)){
                        ?>
                        <td class="member-name"><?php echo $rows['name']; ?></td>
                        <td class="member-contacts"><span><i class='fa fa-phone'></i></span> : <?php echo " ".$rows['mobile']; ?><br/><span><i class='fa fa-envelope'></i></span> :<?php echo " ".$rows['email']; ?></td>
                        <td class="group-role-name"><?php echo $rows['role']; ?></td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#edit_group_member">
                        ...
                        <table class="table table-bordered" id="tbl_posts">
                            ...
                            <tbody id="tbl_posts_body">
                                <tr id="rec-1">
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="txtName[]" placeholder="Member's name" required>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="txtMobile[]" placeholder="+254xxxxxxxxx" required>
                                    </td>
                                    <td>
                                        <input type="email" class="form-control" name="txtMail[]" placeholder="Email address" required>
                                    </td>
                                    <td>
                                        <select class="form-control" name="txtRole[]" required>
                                            <option active value="">Role</option>
                ...
                <div class="modal-header">
                    ...
                    <?php
                        ...
                        while($rowss=mysqli_fetch_assoc($resultss)){
                            $user = $rowss['email'];
                            $result = mysqli_query($conn,"select * from mychama_members where chama='$session' and email='".$user."'") or die(mysqli_error($conn));
                            $row=mysqli_fetch_array($result);
                        }
                        mysqli_close($conn);
                    ?>
                    <center>
                        <h4 class="modal-title">Message Group Member</h4>
                    </center>
                </div>
                <div class="modal-body">
                    <div class="table table-responsive">
	...
	$(document).ready(function(){
        ...
        $('.modal_form_submit').on('submit',function(e){
            ...
            if(parent_form.find('#add_group_members_holder').is(':visible')){
                ...
                if(entries_are_valid){
                    $.ajax({
                        type: "POST",
                        url: 'group/members/ajax_add_members',
                ...
                $.post('group/members/ajax_edit',{'first_name':first_name,'last_name':last_name,'phone':phone,'email':email,'group_role_id':group_role_id,'id':id,'user_id':user_id,},function(data){
                    if(isJson(data)){
        ...
        $('#stackable_submit_form').on('submit',function(e){
            ...
            if(form.find('#group_role_form_holder').is(':visible')){
                ...
                $.ajax({
                    type: "POST",
                    url: 'group/group_roles/ajax_create',
                    data: form.serialize(),
                    success: function(response) {
                        if(isJson(response)){
...
<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/js.cookie.min.js"></script>-->
...
<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js"></script>-->
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/jquery.blockui.min.js"></script>
<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/jquery-minicolors/jquery.minicolors.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/moment.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js"></script>
-->
...
<!--
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/clockface/js/clockface.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js"></script>-->
...
<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/scripts/app.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/components-color-pickers.js"></script>
-->
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/select2/js/select2.full.min.js"></script>
<!--
<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/profile.min.js"></script>
-->
...
<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootbox/bootbox.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/ui-bootbox.min.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/jquery-nestable/jquery.nestable.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/ui-nestable.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/global/scripts/datatable.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/datatables/datatables.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/table-datatables-fixedheader.js"></script>

<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-markdown/lib/markdown.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-markdown/js/bootstrap-markdown.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-summernote/summernote.min.js"></script>-->

<!--<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/components-editors.js"></script>

<script type="text/javascript" src="templates/admin_themes/groups/js/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js"></script>-->


<!--<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/components-bootstrap-maxlength.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/pages/scripts/components-date-time-pickers.min.js"></script>-->

<script type="text/javascript" src="templates/admin_themes/groups/js/layouts/layout4/scripts/layout.min.js"></script>
<!--<script type="text/javascript" src="templates/admin_themes/groups/js/layouts/layout4/scripts/demo.min.js"></script>
<script type="text/javascript" src="templates/admin_themes/groups/js/layouts/global/scripts/quick-sidebar.min.js"></script>-->
