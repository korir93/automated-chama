						...
						<div class="portlet light bordered">
                                <div class="portlet-title ">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject bold font-green uppercase"> Your Group Setup Tasks</span>
                                        <span class="caption-helper">You have completed your group set up tasks on MyChama.</span>
                                    </div>
                                    <div class="tools">
                     ...
                     <div class="portlet light bordered">
                        <div class="portlet-title tabbable-line">
                            <div class="caption">
                                ...
                                <span class="caption-subject ">Deposit</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="tab-content">
                                    ...
                                    <table class="table table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td class="member-name"><?php echo $rows['mobile']; ?></td>
                                                <td class="member-name"><?php echo $rows['email']; ?></td>
                                                <td class="member-name"><?php echo $rows['role']; ?></td>
                                            </tr>
